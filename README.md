...
- **Sammlungen** – vom Admin angelegte Kategorien mit Zweck; Inhalte als Markdown, Bild, Video oder Link (Upload oder URL), jede Änderung versioniert mit Verlauf und Wiederherstellen. Optional pro Sammlung eine **Struktur**: ein vom Admin visuell zusammengestelltes Formular (Fragen, Chips, Dropdowns, Checkboxen, Frage-Antwort-Paare, editierbares Prozessdiagramm mit Verzweigungen), über das Mitglieder strukturierte Einträge anlegen; jeder Eintrag wird deterministisch zu Markdown (inkl. Mermaid-Flowchart) und ist als `.md` exportierbar – z. B. als Rohmaterial für System Prompts oder Skill-Dateien.
