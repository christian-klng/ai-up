...
export type StructureElement =
  ...
  | (StructureElementBase & { type: "markdown"; placeholder?: string; maxLength?: number })
...
export type StructureAnswerValue = string | boolean | string[] | QaPair[] | ProcessGraph | ImageAnswer | LinkAnswer | VideoAnswer;
