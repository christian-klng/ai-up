 ...
 */
export const API_SCOPES = ["workflows:read", "workflows:write", "runs:read", "runs:trigger", "llm:read", "questions:read", "landing:read", "landing:write", "knowledge:read", "knowledge:write"] as const;
